...
! function(a) {
    ...
    }, "Your ZIP-code must be in the range 902xx-xxxx to 905xx-xxxx"),a.validator.addMethod("isValidPhoneNumber", function(a, b) {
    	return this.optional(b) || CommonUtils.isValidPhoneNumber(a);
    }, (typeof  formatPhoneErr !== 'undefined')?formatPhoneErr:"Nhập sai định dạng số điện thoại."), a
});