...
//    google.maps.event.addListener(this.marker_, "icon_changed", function () {
//      me.labelDiv_.url = me.marker_.get("icon");
//    }),
...
//  this.labelDiv_.url = this.marker_.get("icon").url;
};
...
//  opt_options.icon = opt_options.icon || "";
