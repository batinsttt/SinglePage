...
},beforePageText:msgCommonGrid1,afterPageText:msgCommonGrid4 +" {pages}",displayMsg:msgCommonGrid2 + " {from} " + msgCommonGrid3 +" {to} " +msgCommonGrid4 +" {total} " +msgCommonGrid5 ,nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.messager.defaults={ok:msgText6,cancel:msgText7};
})(jQuery);
(function($){
function _292(_293){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"Trường này là bắt buộc nhập.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"Nhập một địa chỉ email hợp lệ."},url:{validator:function(_443){
...
var td=$("<td rowspan=\""+opts.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">"+rowNum+"</div></td>");
if($("tr",t).length==0){
...
var _567=_565(tr);
if(tt.parent().hasClass("removecheck")){
if(opts.singleSelect&&opts.selectOnCheck){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",contentType:"application/x-www-form-urlencoded; charset=utf-8",nowrap:true,idField:null,url:null,data:null,loadMsg:msgText1,rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_70a,_70b){
},loader:function(_70c,_70d,_70e){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_70c,dataType:"json",contentType:opts.contentType,success:function(data){
_70d(data);
},error:function(){
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:false,align: 'left'},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_749,groupField:"group",groupFormatter:function(_770,rows){
return _770;
}});
})(jQuery);
(function($){
...
var span=$("<span class=\"combo\">"+"<div class=\"input-group\"><input type=\"text\" class=\"combo-text\" style=\"width: 90%;\" autocomplete=\"off\">"+"<span class=\"textbox-addon textbox-addon-right\" style=\"right: 0px; top: 0px;\"><span class=\"fa fa-angle-down\"></span></span></div>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_847);
...
_932(this,q);
}},currentText:"Hôm nay",closeText:"Đóng",okText:"Ok",buttons:[{text:function(_945){
...
$.fn.datebox.defaults.formatter = function(date){
	var y = date.getFullYear();
	var m = (date.getMonth()+1).toString().length>1?(date.getMonth()+1):'0'+(date.getMonth()+1);
	var d = date.getDate().toString().length>1?date.getDate():'0'+date.getDate();
