...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp,gid){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+lft+"' style='width:0px;' align='left'></td><td id='"+cent+"' align='center' style='white-space:pre;'></td><td id='"+rgt+"' align='right'></td></tr></tbody></table></div>")
			...
			str+= '<td><div class="LoadGrid" id="load_'+gid+'"><img src="' + WEB_CONTEXT_PATH + '/resources/images/loading.gif" class="LoadingStyle"/></div></td>';
			if(dir=="rtl") { pgl += str; }
		...
		if(ts.p.toppager) {
			...
			setPager(ts.p.toppager,'_t',ts.id);
		}
		if(ts.p.footerrow) {
