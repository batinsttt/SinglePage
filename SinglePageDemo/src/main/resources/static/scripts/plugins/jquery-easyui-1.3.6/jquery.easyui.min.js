...
(function ($) {
    ...
    function _98(_99) {
        ...
        if(_9a.text == confirmPoppupOk){
        	t.addClass("btn-dong-y");
        }
        if (_9a.plain) {
    ...
    function _ac(_ad) {
        ...
        for (var _b2 = 0; _b2 < aa.length; _b2++) {
            ...
            if (_b3 == "list") {
				 ...
				 * ps.bind("change", function () { _af.pageSize =
				 * parseInt($(this).val()); _af.onChangePageSize.call(_ad,
				 * _af.pageSize); _b9(_ad, _af.pageNumber); }); for (var i = 0;
				 * i < _af.pageList.length; i++) { $("<option></option>").text(_af.pageList[i]).appendTo(ps); }
...
// },beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying
// {from} to {to} of {total}
// items",nav:{first:{iconCls:"pagination-first",handler:function(){
        },
        beforePageText: tablePage,
        afterPageText: tableoutOf+" "+"{pages}",
        displayMsg: tableDis1+" "+"{to}"+" "+tableDis2+" "+ "{total}"+" "+ tableDis3,
        nav: {
            first: {
    ...
    function _28f(_290) {
        ...
        var win = $(_290).panel($.extend({}, _291.options, {
            ...
            onClose: function () {
                ...
                $.data(_290, "dialog").options.closed=true;
                opts.onClose.call(_290);
            },
            onOpen: function () {
            	var panelOpts = $.data(_290, "panel").options;
            	var widthWinDow = window.width ;  
                var heightWindow = window.height ;  
                var widthPanel = $(_290,"panel").outerWidth() ;
                var heighPanel = $(_290,"panel").outerHeight() ;
                centerLeft = (widthWinDow - widthPanel) /2;
                centerTop = (heightWindow - heighPanel) /2;
                if (_291.mask) {
                ...
                if(centerLeft > 20) {
                	$.data(_290, "panel").options.left = centerLeft;
                }
                if($('#'+panelOpts.id).find(".GridSection").length >0 || $('#'+panelOpts.id).find(".easyui-tree").length >0){
                	$.data(_290, "panel").options.top = 50;
                } else {
                	if(centerTop > 20) {
                    	$.data(_290, "panel").options.top = centerTop;
                    }
                }
                opts.onOpen.call(_290);
                window.scrollTo(300, centerTop - 250);
            },
        ...
        $(_2ae).window($.extend({}, opts, {
            onResize: function (w, h) {
                if (opts.inited) {
                    ...
                    var left1 = ((width / 2) - (w / 2)) + dualScreenLeft;  
                    var top1 = 50;
                    if(h !='auto'){
                    	top1 = ((height / 2) - (h / 2)) + dualScreenTop;
                    }
                	opts.top = top1;
                	opts.left = left1;
                    _2b3(this);
...
(function ($) {
    ...
    function _2ca(_2cb) {
        ...
        if( $(".dialog-button .l-btn:not(:hidden)").length == 1){
        	$(".dialog-button .l-btn:not(:hidden)").removeClass('btn-dong-y');
        }
    ...
    $.messager = {
        show: function (_2cd) {
            ...
            opts = $.extend({}, $.messager.defaults, {content: "<div class=\"" + cls + "\"></div>" + "<div class=\"AlignCenter\">" + opts.msg + "</div>" + "<div style=\"clear:both;\"/>"}, opts);
            if (!opts.buttons) {
                opts.buttons = [{
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        ...
        events: {
            focus: _4ca, blur: _4ce, mouseenter: _4d1, mouseleave: _4d4, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _502(_503) {
        ...
        if (opts.multiline) {
            ...
            $("<input id=\"" + _505 + "\" maxlength=\"15\" type=\"" + opts.type + "\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
        }
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        revealed: false,
        showEye: true,
        inputEvents: {focus: _563, blur: _567},
        val: function (_570) {
...
(function ($) {
    ...
    function load(_5d2, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _5d3, dataType: "json", success: function (data) {
                    _5d4(data);
                }, error: function () {
...
(function ($) {
    function _63c(_63d) {
        ...
        $(_63d).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _63f, doSize: false, onResize: function (_641, _642) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    function _6c5(_6c6) {
        ...
        _6c8.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_6c9, _6ca) {
    ...
    function _6ea(e) {
        ...
        if( $('#divCustomerDetail').val() !== undefined ) {
           ck = $(e.target).closest("input[ctrltype=select]");
        }
        if (ck.length) {
    ...
    function _6fb(e) {
        ...
        if (tt.parent().hasClass("el-checkbox-lg") && !tt.hasClass("el-checkbox-style.el-lebel") && !tt.hasClass("el-lebel") ) {
            if (opts.singleSelect && opts.selectOnCheck) {
...
//                    tt._propAttr("checked", false);
    ...
    function _718(_75e, data) {
        ...
        //Add td scroll with table have scroll overflow-x
        if ( !$(_75e).prev('.datagrid-view2').find('.datagrid-htable .datagrid-header-row td[field=scroll]').length ) {
	        if ($(_75e).prev('.datagrid-view2').find('.datagrid-body:not(:hidden)').css("width") 
	                    		< $(_75e).prev('.datagrid-view2').find('.datagrid-body .datagrid-btable:not(:hidden)').css("width")) {
                    		$(_75e).prev('.datagrid-view2').find('.datagrid-htable .datagrid-header-row').append( "<td field='scroll' style='padding-right: 11px;'></td>" )
	        }
        }
    ...
    function _6fe(_796, _797, _798) {
        ...
        if (tr.length == opts.finder.getRows(_796).length && $('#routingCustomerContainerGrid').length == 0) {
            var dc = _799.dc;
    ...
    function _6ff(_79a, _79b, _79c) {
        ...
        var tr = opts.finder.getTr(_79a, _79b).removeClass("removecheck");
...
//        var bck = opts.finder.getTr(_79f, "", "allbody").addClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
        var bck = opts.finder.getTr(_79f, "", "allbody").addClass('datagrid-row-selected-custom').find("div.datagrid-cell-check input[type=checkbox]");
    ...
    function _6ed(_7a2, _7a3) {
        ...
        var dc = _7a4.dc;
        var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
        var bck = opts.finder.getTr(_7a2, "", "checked").removeClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked", false);
//        find("div.datagrid-cell-check input[type=checkbox]");
        hck.add(bck)._propAttr("checked", false);
        //uncheck all checkbox in body
        $("div.datagrid-cell-check input[type=checkbox]").closest('tr').removeClass('datagrid-row-selected-custom');
        $("div.datagrid-cell-check input[type=checkbox]").prop("checked", false);
        if (opts.idField) {
            for (var i = 0; i < rows.length; i++) {
            ...
            if (col && col.editor) {
                ...
                if (_7c5) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _7c5,
                        target: _7c5.init(cell.find("td"), $.extend({height: opts.editorHeight}, _7c4)),
                        field: _7c2,
                        type: _7c3,
                        oldHtml: _7c6
                    });
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        url: null,
        data: null,
        loadMsg: waitingDatagridLoadding,
        emptyMsg: "",
        rownumbers: false,
        singleSelect: false,
        ctrlSelect: false,
        ...
        rownumberWidth: 30,
        editorHeight: 31,
        headerEvents: {mouseover: _6e6(true), mouseout: _6e6(false), click: _6ea, dblclick: _6ef, contextmenu: _6f2},
        rowEvents: {mouseover: _6f4(true), mouseout: _6f4(false), click: _6fb, dblclick: _705, contextmenu: _709},
        ...
        loader: function (_8a6, _8a7, _8a8) {
            ...
            Report.currentXhr = $.ajax({
                type: opts.method, url: opts.url, data: _8a6, dataType: "json", success: function (data) {
                    _8a7(data);
                }, error: function () {
    ...
    function _963(e) {
        ...
        if (tt.hasClass("tree-hit")) {
            ...
            if (tt.hasClass("tree-checkbox")) {
                ...
                if (tt.parent().hasClass("el-checkbox-lg") && !tt.hasClass("el-checkbox-style.el-lebel") 
                && !tt.hasClass("el-lebel") ) {
	                if (!opts.singleSelect && e.shiftKey) {
    ...
    var _9eb = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9ec, _9ed, _9ee) {
            ...
            function _a0f(_a10) {
                ...
                if (_a13) {
                    tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked", true);
                    tr.find("div.datagrid-cell-check input[type=checkbox]").addClass('datagrid-row-selected-custom');
                }
                if (_a0e != id) {
    ...
    function _a37(_a38) {
        ...
        $(_a38).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_a39, row, _a3a) {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _a6c, keydown: _a70, paste: _a70, drop: _a70, blur: _a73},
        panelEvents: {
...
(function ($) {
    ...
    function _ab6(_abc, _abd, _abe) {
        ...
        if (!_abe) {
            $(_abc).combo("setText", ss.join(opts.separator).trim());
        }
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        panelEvents: {
            mouseover: _adb, mouseout: _adc, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _add, scroll: _ae0
        },
        ...
        loader: function (_b00, _b01, _b02) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _b00, dataType: "json", success: function (data) {
                    _b01(data);
                }, error: function () {
    ...
    $.fn.combogrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combogrid").options, {
                width: _b78.width,
                height: _b78.height,
                originalValue: _b78.originalValue,
                disabled: _b78.disabled,
                readonly: _b78.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).combo("cloneFrom", from);
...
(function ($) {
    function _b7e(_b7f) {
        ...
        $(_b7f).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.treegrid("resize", {
                    width: "100%",
                    height: (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"),
                    minHeight: (_b82 ? _b82 - _b81 : ""),
                    maxHeight: (_b83 ? _b83 - _b81 : "")
                });
        ...
        _b80.grid.treegrid($.extend({}, opts, {
    ...
    $.fn.combotreegrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotreegrid").options, {
                width: _b9f.width,
                height: _b9f.height,
                originalValue: _b9f.originalValue,
                disabled: _b9f.disabled,
                readonly: _b9f.readonly
            });
        }, grid: function (jq) {
...
(function ($) {
    function _ba5(_ba6) {
        ...
        $(_ba6).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_ba8, _ba9) {
                _baa();
    ...
    function _bc1(_bc2) {
        ...
        tmp.css({
            ...
            left: -9999,
            width: "auto",
            fontFamily: _bc3.css("fontFamily"),
            fontSize: _bc3.css("fontSize"),
            fontWeight: _bc3.css("fontWeight"),
            whiteSpace: "nowrap"
        });
    ...
    $.fn.tagbox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "tagbox").options, {
                width: _bd4.width,
                height: _bd4.height,
                originalValue: _bd4.originalValue,
                disabled: _bd4.disabled,
                readonly: _bd4.readonly
            });
...
(function ($) {
    function _bde(_bdf) {
        ...
        $(_bdf).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _be1(this);
                _be2(this);
                _be3(this);
        ...
        if (!_be0.calendar) {
            ...
            $.extend(_be0.calendar.calendar("options"), {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 250, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_c04) {
                ...
                $(_c05).datebox("calendar").calendar({
                    year: _c06.getFullYear(),
                    month: _c06.getMonth() + 1,
                    current: _c06
                });
...
(function ($) {
    function _c09(_c0a) {
        ...
        $(_c0a).datebox("calendar").calendar({
            onSelect: function (date) {
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _c1f.originalValue,
                disabled: _c1f.disabled,
                readonly: _c1f.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
...
(function ($) {
    ...
    function _c40(_c41) {
        ...
        _c43.find("a.slider-handle").draggable({
    ...
    $.fn.slider = function (_c62, _c63) {
        ...
        return this.each(function () {
            ...
            if (_c64) {
                ...
                _c64 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _c62),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_c68) {
        var t = $(_c68);
        return $.extend({}, $.parser.parseOptions(_c68, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_c69) {
            return _c69;
        },
        converter: {
            toPosition: function (_c6a, size) {
                var opts = $(this).slider("options");
