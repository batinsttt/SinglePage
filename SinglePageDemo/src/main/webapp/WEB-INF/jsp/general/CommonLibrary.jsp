<%@page import="com.sttt.ruby.config.ConfigurationPath"%>
 ...
 <!-- style.css -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/css/style.min.css")%>">
...
<link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/bower_components/dataTables/dataTables.bootstrap4.css")%>">
 ...
 <!-- Theme style -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/css/AdminLTE.min.css")%>">
 <!-- AdminLTE Skins -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/css/skins/_all-skins.min.css")%>">
 
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/css/components.min.css")%>">
 <!-- Morris chart -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/bower_components/morris.js/morris.css")%>">
 <!-- jvectormap -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/bower_components/jvectormap/jquery-jvectormap.css")%>">
 <!-- Date Picker -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css")%>">
 <!-- Daterange picker -->
 <link rel="stylesheet" href="<%=ConfigurationPath.getCssServerPath("/bower_components/bootstrap-daterangepicker/daterangepicker.css")%>">
...
<!-- Morris.js charts -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/raphael/raphael.min.js")%>"></script>
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/morris.js/morris.min.js")%>"></script>
<!-- Sparkline -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js")%>"></script>
<!-- jvectormap -->
<%-- <script src="<%=ConfigurationPath.getCssServerPath("/bower_components/jvectormap/jquery-jvectormap-1.2.2.min.js")%>"></script> --%>
<%-- <script src="<%=ConfigurationPath.getCssServerPath("/bower_components/jvectormap/jquery-jvectormap-world-mill-en.js")%>"></script> --%>
<!-- jQuery Knob Chart -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/jquery-knob/dist/jquery.knob.min.js")%>"></script>
<!-- daterangepicker -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/moment/min/moment.min.js")%>"></script>
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/bootstrap-daterangepicker/daterangepicker.js")%>"></script>
<!-- datepicker -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js")%>"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<!-- FastClick -->
<script src="<%=ConfigurationPath.getCssServerPath("/bower_components/fastclick/lib/fastclick.js")%>"></script>
<!-- AdminLTE App -->
<script src="<%=ConfigurationPath.getCssServerPath("/scripts/adminlte.min.js")%>"></script>
<!-- Metronic App -->
<script src="<%=ConfigurationPath.getCssServerPath("/scripts/metronic.min.js")%>"></script>
